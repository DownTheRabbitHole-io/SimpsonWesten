<div class="content">
	<div class="container-fluid">
		<div class="row">
			<div class="main col-xs-12 col-sm-9 profile">
        ...
        <!-- $ProfileImage -->
				...
				<h1>$Name <span class="t2-plus" style="margin-left:30px;">$Jobtitle</span></h1>
        ...
        <p><strong>Phone:</strong> $Phone</p>
				...
				<p><strong>Email:</strong> <a href="mailto:$Email" title="Click to Email">Click to Email</a></p>
				<p><strong>PA:</strong>  $PA</p>
				<p><strong>Linkedin:</strong> <a href="$Linkedin" target="_blank">Click Here</a></p>
        </article>
			</div>
		</div>
	</div>
